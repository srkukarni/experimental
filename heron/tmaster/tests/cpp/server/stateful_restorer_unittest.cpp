...
struct CommonResources {
  ...
  CommonResources() : topology_(NULL), tmaster_(NULL), tmaster_thread_(NULL), tmaster_piper_(NULL) {
  }
};
...
TEST(StatefulRestorer, test_restore_send) {
  ...
  sp_int64 txid = restorer->RestoreTxid();
